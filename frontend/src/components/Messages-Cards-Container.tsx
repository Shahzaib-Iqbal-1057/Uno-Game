    ...
    return (
        <div className = "messages-and-cards-container">
            <div className = "right-side-container messages-container mt-5">
                ...
                <input className="message-input-container bg-black border-none focus:outline-none" placeholder="Enter Message Here" value={message} onChange = {handleChange} onKeyDown = {handleKeyDown}>
                </input>
            </div>
